...
namespace WpfTestApp.ViewModels
{
	...
	public class TestPointEditorViewModel : BindableBase, IDisposable, IConfirmNavigationRequest
	{
		#region "プロパティ"
		...
		{
			this.TestDate.ForceValidate();
			this.JapaneseScore.ForceValidate();
			this.MathematicsScore.ForceValidate();
			this.EnglishScore.ForceValidate();

			var isMove = !(this.TestDate.HasErrors |
						   this.JapaneseScore.HasErrors |
						   this.MathematicsScore.HasErrors |
						   this.EnglishScore.HasErrors);
