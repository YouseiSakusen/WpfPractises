...
namespace PrismNetCoreApp.Behaviors
{
	public class WindowClosingBehavior : Behavior<Window>
	{
		...
		public static readonly DependencyProperty CanCloseProperty =
			DependencyProperty.Register("CanClose", typeof(bool), typeof(WindowClosingBehavior),
		...
		public static readonly DependencyProperty CloseCanceledCallbackCommandProperty =
			DependencyProperty.Register("CloseCanceledCallbackCommand", typeof(ICommand),
				typeof(WindowClosingBehavior), new PropertyMetadata(null));
